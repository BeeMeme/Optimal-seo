...
class main_controller
{
	...
	{
		$l_message = !$this->config['bestpickrs_optimalseo_goodbye'] ? 'OPTIMALSEO_HELLO' : 'OPTIMALSEO_GOODBYE';
		$this->template->assign_var('OPTIMALSEO_MESSAGE', $this->language->lang($l_message, $name));

		return $this->helper->render('@bestpickrs_optimalseo/optimalseo_body.html', $name);
	}
}
